        ...
        try {
            ...
            Say.err(
                ...
                null,
                {
                    ...
                    validID_width: validID ? validID.width : '',
                    validID_height: validID ? validID.height : '',
                    face_filesize: profilepic ? `${profilepic.filesize} kb` : '',
                    face_width: profilepic ? profilepic.width : '',
                    face_height: profilepic ? profilepic.height : '',
